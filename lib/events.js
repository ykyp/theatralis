...
export function getSortedEventsData() {
  ...
  return allEventsData.sort((a, b) => {
    console.log("unformatted date ", a.startDate);
    ...
    console.log("getDay", dateA.getDate());
    console.log("DB", new Date(dateB.getFullYear(),  dateB.getMonth(), dateB.getDate()+1));
    console.log("DA", new Date(dateA.getFullYear(),  dateA.getMonth(), dateA.getDate()+1));
