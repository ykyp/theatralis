...
\*Οι Προγραμματισμένες παραστάσεις την Παρασκευή και το Σαββατοκύριακο 11 και 12,13 Φεβρουαρίου αναβάλλονται λόγω ασθένειας συντελεστή. Θα επανέλθουμε με νέα ανακοίνωση για τις επόμενες ημερομηνίες παραστάσεων.Ευχαριστούμε για την κατανόηση.
