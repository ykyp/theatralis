...
export default function Layout({ children, home, pageTitle, description, currentURL, previewImage, siteName, fbTitle, fbSiteName, onSearchChange }) {
  ...
  return (
    <div className={`antialiased w-full text-gray-700`}>
      <Head>
       ...
       { home && <Hero onSearchChange={onSearchChange}/> }
